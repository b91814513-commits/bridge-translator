export const LANG_STORAGE_KEY = "bridge-homepage-lang";
export const THEME_STORAGE_KEY = "bridge-homepage-theme";
...
const baseContent = {
  en: {
    ...
    subtitle:
      "Bridge Translator brings page translation, selection lookup, input-box translation, and YouTube subtitles into one lightweight browser extension and userscript.",
    ...
    installs: [
      {
        ...
        href: "https://chrome.google.com/webstore/detail/bridge-translator/bdiifdefkgmcblbcghdlonllpjhhjgof?hl=en",
      },
      {
        name: "Edge",
        meta: "Browser extension",
      ...
      },
      {
        name: "Firefox",
        meta: "Browser extension",
        href: "https://addons.mozilla.org/en-US/firefox/addon/bridge-translator/",
      },
      {
        name: "Thunderbird",
    ...
    features: [
      ...
      {
        title: "Private sync",
        body: "Synchronize settings through WebDAV while keeping data under your control.",
      },
    ],
    providers: [
      "OpenAI",
...
const translations = {
  zh_CN: {
    ...
    subtitle:
      "Bridge Translator 将网页翻译、划词查询、输入框翻译和 YouTube 字幕整合到一个轻量的浏览器扩展与油猴脚本中。",
  ...
  zh_TW: {
    ...
    subtitle:
      "Bridge Translator 將網頁翻譯、劃詞查詢、輸入框翻譯和 YouTube 字幕整合到輕量的瀏覽器擴充套件與使用者腳本中。",
  ...
  ja: {
    ...
    subtitle:
      "Bridge Translator はページ翻訳、選択テキスト翻訳、入力欄翻訳、YouTube 字幕翻訳を軽量な拡張機能とユーザースクリプトにまとめます。",
    ...
    features: [
      ...
      {
        title: "プライベート同期",
        body: "WebDAV で設定を同期し、データを管理できます。",
      },
    ],
  },
  ko: {
    ...
    subtitle:
      "Bridge Translator는 웹페이지 번역, 선택 번역, 입력창 번역, YouTube 자막 번역을 가벼운 브라우저 확장과 유저스크립트로 제공합니다.",
    ...
    features: [
      ...
      {
        title: "개인 동기화",
        body: "WebDAV로 설정을 동기화하고 데이터를 직접 관리합니다.",
      },
    ],
  },
  fr: {
    ...
    subtitle:
      "Bridge Translator regroupe traduction de pages, selection de texte, champs de saisie et sous-titres YouTube dans une extension et un userscript legers.",
    ...
    features: [
      ...
      },
      {
        ...
        body: "Synchronisez via WebDAV en gardant vos donnees sous controle.",
      },
    ],
  },
  de: {
    ...
    subtitle:
      "Bridge Translator bundelt Seitenubersetzung, Auswahlubersetzung, Eingabefeld-Ubersetzung und YouTube-Untertitel in einer schlanken Erweiterung und einem Userscript.",
    ...
    features: [
      ...
      },
      {
        ...
        body: "Synchronisieren Sie uber WebDAV und behalten Sie die Datenkontrolle.",
      },
    ],
  },
  es: {
    ...
    subtitle:
      "Bridge Translator une traduccion de paginas, seleccion de texto, campos de entrada y subtitulos de YouTube en una extension y un userscript ligeros.",
    ...
    features: [
      ...
      },
      {
        ...
        body: "Sincroniza con WebDAV autoalojado manteniendo tus datos bajo control.",
      },
    ],
  },
};
