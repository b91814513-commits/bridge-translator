...
export const MSG_FETCH = "bridge_fetch"; // 代理请求 (避免内容脚本跨域限制)
...
export const PORT_STREAM_FETCH = "bridge_stream_fetch"; // 双向长连接端口名称：用于大模型翻译时的流式输出通道
...
export const EVENT_KISS_INNER = "bridge_translator_inner"; // 插件沙箱/内容脚本内部事件
export const EVENT_KISS_TRANSLATOR = "bridge_translator"; // 暴露给网页环境的外部交互事件

// --- 视频与字幕翻译特定消息类型 ---
export const MSG_XHR_DATA_YOUTUBE = "BRIDGE_XHR_DATA_YOUTUBE"; // 传递 YouTube 拦截到的字幕 XHR 数据

// --- 网页总结相关消息类型 ---
export const BRIDGE_SUMMARIZE_PAGE = "bridge_summarize_page"; // 请求后台生成网页总结
export const BRIDGE_SUMMARY_RESULT = "bridge_summary_result"; // 后台返回总结结果
export const BRIDGE_SUMMARIZE_TRIGGER = "bridge_summarize_trigger"; // 快捷键触发通知 content script

// --- 视频总结相关消息类型 ---
export const BRIDGE_VIDEO_SUMMARY = "bridge_video_summary"; // 请求后台生成视频总结
export const BRIDGE_VIDEO_SUMMARY_RESULT = "bridge_video_summary_result"; // 后台返回视频总结结果
