...
export const I18N = {
  app_name: {
    zh: `Bridge Translator`,
    en: `Bridge Translator`,
    zh_TW: `Bridge Translator`,
    ja: `Bridge Translator`,
    ko: `Bridge Translator`,
  },
  translate: {
    zh: `翻译`,
    en: `Translate`,
  ...
  video_summary_sections: {
    en: "Detailed Sections",
    zh: "分段详情",
    zh_TW: "分段詳情",
    ja: "セクション詳細",
    ko: "세부 섹션",
  },
  video_summary_highlights: {
    en: "Notable Highlights",
    zh: "精彩亮点",
    zh_TW: "精彩亮點",
    ja: "ハイライト",
    ko: "하이라이트",
  ...
  video_summary_error: {
    en: "Failed to generate video summary",
    zh: "生成视频总结失败",
    zh_TW: "產生影片總結失敗",
    ja: "動画要約の生成に失敗",
    ko: "영상 요약 생성 실패",
  ...
  video_summary_no_subtitles: {
    en: "No subtitle data available. Please enable bilingual subtitles first.",
    zh: "暂无字幕数据，请先开启双语字幕。",
    zh_TW: "暫無字幕資料，請先開啟雙語字幕。",
    ja: "字幕データがありません。先にバイリンガル字幕を有効にしてください。",
    ko: "자막 데이터가 없습니다. 먼저 이중 언어 자막을 활성화하세요.",
  },
  video_summary_retry: {
    en: "Retry",
    zh: "重试",
  ...
  sync_warn: {
    zh: `涉及隐私数据的同步请谨慎选择第三方同步服务，建议自行搭建 WebDAV 服务。`,
    en: `When synchronizing data that involves privacy, please be cautious about choosing third-party sync services. It is recommended to set up your own sync service using WebDAV.`,
    zh_TW: `同步涉及隱私資料時，請謹慎選擇第三方同步服務；建議自行架設 WebDAV 服務。`,
    ja: `プライバシーに関わるデータを同期する場合、サードパーティの同期サービスは慎重に選択してください。WebDAV サービスを自己ホスティングすることをお勧めします。`,
    ko: `개인정보가 포함된 데이터를 동기화할 경우, 타사 동기화 서비스 선택에 신중을 기하십시오. 자체 WebDAV 서비스를 구축하는 것을 권장합니다.`,
  },
  sync_warn_gist: {
  ...
  sync_upload_success: {
    zh: `成功上传到云端`,
    en: `Successfully uploaded to cloud`,
    zh_TW: `成功上傳到雲端`,
    ja: `クラウドへのアップロードに成功`,
    ko: `클라우드 업로드 성공`,
  },
  ...
  sync_download_success: {
    zh: `成功从云端下载`,
    en: `Successfully downloaded from cloud`,
    zh_TW: `成功從雲端下載`,
    ja: `クラウドからのダウンロードに成功`,
    ko: `클라우드 다운로드 성공`,
  },
  ...
  sync_download_confirm: {
    zh: `下载将覆盖本地设置，是否继续？`,
    en: `Downloading will overwrite local settings. Continue?`,
    zh_TW: `下載將覆蓋本地設定，是否繼續？`,
    ja: `ダウンロードするとローカル設定が上書きされます。続行しますか？`,
    ko: `다운로드하면 로컬 설정이 덮어씌워집니다. 계속하시겠습니까?`,
  },
  // --- 本地配置导入/导出 ---
  local_config: {
    zh: `本地配置`,
  ...
  import_config_confirm: {
    ...
    zh_TW: `匯入將覆蓋目前設定，是否繼續？`,
    ja: `インポートすると現在の設定が上書きされます。続行しますか？`,
    ko: `가져오면 현재 설정이 덮어씌워집니다. 계속하시겠습니까?`,
  },
  ...
  import_config_failed: {
    zh: `配置导入失败`,
    en: `Config import failed`,
    zh_TW: `設定匯入失敗`,
    ja: `設定のインポートに失敗`,
    ko: `설정 가져오기 실패`,
  },
  export_config_tip: {
    zh: `注意：导出的配置文件不包含 API 密钥和同步密码等敏感信息，导入后需手动重新填写。`,
    en: `Note: The exported config file does not include API keys, sync passwords or other sensitive info. You will need to re-enter them after importing.`,
    zh_TW: `注意：匯出的設定檔不包含 API 金鑰和同步密碼等敏感資訊，匯入後需手動重新填寫。`,
    ja: `注意：エクスポートされる設定ファイルには API キーや同期パスワードなどの機密情報は含まれません。インポート後に手動で再入力してください。`,
    ko: `참고: 내보낸 설정 파일에는 API 키, 동기화 비밀번호 등 민감 정보가 포함되지 않습니다. 가져오기 후 직접 다시 입력해야 합니다.`,
  },
  ...
  btn_tip_dark_mode: {
    zh: `亮色/暗色/跟随系统/浅粉色`,
    en: `Light/Dark/Auto/Light Pink`,
    zh_TW: `亮色/暗色/跟隨系統/淺粉色`,
    ja: `ライト/ダーク/自動/ライトピンク`,
    ko: `라이트/다크/자동/라이트 핑크`,
  },
  api_placeholder: {
    zh: `占位符`,
  ...
  dictionary_lookup_failed: {
    zh: `释义加载失败，仍可收藏`,
    en: `Definition unavailable. You can still save this word.`,
    zh_TW: `釋義載入失敗，仍可收藏`,
    ja: `定義を読み込めません。単語は保存できます。`,
    ko: `뜻을 불러오지 못했습니다. 단어는 저장할 수 있습니다.`,
  },
  add_to_video_vocabulary: {
    zh: `加入本视频生词本`,
    en: `Add to this video's vocabulary`,
    zh_TW: `加入本影片生詞本`,
    ja: `この動画の単語帳に追加`,
    ko: `이 동영상 단어장에 추가`,
  },
  remove_from_video_vocabulary: {
    zh: `从本视频生词本移除`,
    en: `Remove from this video's vocabulary`,
    zh_TW: `從本影片生詞本移除`,
    ja: `この動画の単語帳から削除`,
    ko: `이 동영상 단어장에서 삭제`,
  },
  ...
  vocabulary_removed: {
    zh: `已从本视频生词本移除`,
    en: `Removed from this video's vocabulary`,
    zh_TW: `已從本影片生詞本移除`,
    ja: `この動画の単語帳から削除しました`,
    ko: `이 동영상 단어장에서 삭제됨`,
  },
  this_video_total: {
    zh: `本视频共`,
    en: `This video now has`,
    zh_TW: `本影片共`,
    ja: `この動画には`,
    ko: `이 동영상에`,
  },
  vocabulary_count_unit: {
    zh: `个词`,
    en: `words`,
    zh_TW: `個詞`,
    ja: `語`,
  ...
  vocabulary_empty_youtube: {
    zh: `暂无生词，可在字幕查词后收藏`,
    en: `No saved words yet. Look up a subtitle word to save it.`,
    zh_TW: `暫無生詞，可在字幕查詞後收藏`,
    ja: `保存した単語はありません。字幕から単語を検索して保存できます。`,
    ko: `저장된 단어가 없습니다. 자막 단어를 조회한 뒤 저장하세요.`,
  },
  vocabulary_ungrouped: {
    zh: `未分组`,
    en: `Ungrouped`,
    zh_TW: `未分組`,
    ja: `未分類`,
  ...
  search_vocabulary: {
    zh: `搜索单词、释义或视频`,
    en: `Search words, definitions, or videos`,
    zh_TW: `搜尋單詞、釋義或影片`,
    ja: `単語、定義、動画を検索`,
    ko: `단어, 뜻 또는 동영상 검색`,
  },
  ...
  web_translate_shortcuts_hint: {
    zh: `请在 chrome://extensions/shortcuts 中配置快捷键`,
    en: `Configure shortcuts at chrome://extensions/shortcuts`,
    zh_TW: `請在 chrome://extensions/shortcuts 中配置快捷鍵`,
    ja: `chrome://extensions/shortcuts でショートカットを設定`,
    ko: `chrome://extensions/shortcuts에서 단축키 설정`,
  },
  web_translate_position_tl: {
    zh: `左上`,
    en: `Top Left`,
    zh_TW: `左上`,
    ja: `左上`,
  ...
  web_translate_auto_sites: {
    zh: `自动翻译特定网站`,
    en: `Auto Translate Sites`,
    zh_TW: `自動翻譯特定網站`,
    ja: `特定サイト自動翻訳`,
    ko: `특정 사이트 자동 번역`,
  },
  web_translate_auto_sites_hint: {
    zh: `每行一个网站域名（支持正则）`,
    en: `One domain per line (regex supported)`,
    zh_TW: `每行一個網站域名（支援正規表示式）`,
    ja: `1行に1つのドメイン（正規表現対応）`,
    ko: `한 줄에 하나의 도메인 (정규식 지원)`,
  },
  web_translate_shortcut_open: {
    zh: `打开扩展`,
    en: `Open Extension`,
    zh_TW: `開啟擴充功能`,
    ja: `拡張機能を開く`,
  ...
  web_translate_shortcut_summary: {
    zh: `网页总结`,
    en: `Page Summary`,
    zh_TW: `網頁總結`,
    ja: `ページ要約`,
  ...
  web_translate_shortcut_manual: {
    zh: `需在 chrome://extensions/shortcuts 中手动设置`,
    en: `Set manually at chrome://extensions/shortcuts`,
    zh_TW: `需在 chrome://extensions/shortcuts 中手動設定`,
    ja: `chrome://extensions/shortcuts で手動設定が必要`,
    ko: `chrome://extensions/shortcuts에서 수동 설정 필요`,
  },
};
