...
export const DEFAULT_COLOR = "#EC407A"; // 默认的生词高亮背景色/波浪线颜色
...
const RULES_MAP = {
  ...
  "www.youtube.com": {
    ...
    ignoreSelector: `aside, button, footer, form, header, pre, mark, nav, #player, #container, .caption-window, .ytp-settings-menu, #bridge-youtube-subtitle-list-container`,
    selectStyle: `-webkit-line-clamp: unset; max-height: none; height: auto;`,
