...
export const KV_RULES_KEY = `bridge-rules_v${APP_VERSION[0]}.json`; // 同步的自定义规则文件名
export const KV_WORDS_KEY = "bridge-words.json"; // 同步的生词本文件名
export const KV_RULES_SHARE_KEY = `bridge-rules-share_v${APP_VERSION[0]}.json`; // 共享/订阅规则文件名
export const KV_SETTING_KEY = `bridge-setting_v${APP_VERSION[0]}.json`; // 同步的全局设置文件名
